let pokemonRepository = (function () {
    ...
    function loadDetails(item) {
        ...
        return fetch(url).then(function (response) {
            ...
            item.imageUrlShiny = details.sprites.other['official-artwork'].front_shiny;
            item.height = details.height;
            item.weight = details.weight;
            item.types = details.types.map((type) => capitalize(type.type.name)).join(', ');
    ...
    function showModal(pokemon) {
        ...
        let abilitiesElement = $("<p class='abilities'>" + "Abilities: " + pokemon.abilities.join(', ') + "</p>");
